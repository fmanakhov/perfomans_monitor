...
| --- | --- |
| Кнопки навигации | Необходимо для удобного перехода по разделам программы (Рисунок 1.1). ![](https://github.com/fmanakhov/perfomans_monitor/blob/main/pic/image001.png) Рисунок 1.1 – Кнопки программы |
