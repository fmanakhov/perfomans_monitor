...
| --- | --- |
| Кнопки навигации | Необходимо для удобного перехода по разделам программы. ![](https://github.com/fmanakhov/perfomans_monitor/blob/main/pic/image001.png) |
| О программе | Информации программы. ![](https://github.com/fmanakhov/perfomans_monitor/blob/main/pic/image002.png) |
| Раздел «Общая информация» | Находится общая информация о операционной системе, процессоре, оперативной памяти, видеокарте, физических дисков. ![](https://github.com/fmanakhov/perfomans_monitor/blob/main/pic/image003.png) |
| Разделы «ЦП, ОЗУ, ГП, Диски» | Находятся информация о конкретном компоненте компьютере, график использованной компонента компьютера в режиме реального времени. ![](https://github.com/fmanakhov/perfomans_monitor/blob/main/pic/image004.png) |
